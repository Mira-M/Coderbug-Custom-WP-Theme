      ...
      <div class="row resume-row">
        ...
        <div class="col-xs-12 col-sm-5">
          ...
          <div class="box clearfix">
            ...
            <div class="contact-item">
              <div class="icon pull-left text-center"><a href="https://twitter.com/coderbug83"><span class="fa fa-twitter fa-fw"></span></a></div>
              <div class="title pull-right">Twitter</div>
              <div class="description pull-right">https://twitter.com/coderbug83</div>
            </div>
            <div class="contact-item">
              <div class="icon pull-left text-center"><a href="https://www.facebook.com/coderbug83"><span class="fa fa-facebook fa-fw"></span></a></div>
              <div class="title pull-right">Facebook</div>
              <div class="description pull-right">https://www.facebook.com/coderbug83</div>
            </div>
            <div class="contact-item">
              <div class="icon pull-left text-center"><a href="https://github.com/Mira-M"><span class="fa fa-github-alt fa-fw"></span></a></div>
